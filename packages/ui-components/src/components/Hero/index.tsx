...
type HeroVariant = 'default' | 'luxury' | 'adventure' | 'family';
  ...
  return (
    <section className="relative pt-24 bg-white dark:bg-gray-900 bg-cover text-white">
      <div className="container mx-auto max-w-7xl lg:px-0 px-4 relative z-10">
        <div
          className="bg-no-repeat bg-cover sm:p-24 p-10 px-4 bg-center rounded-3xl grid grid-cols-12"
        ...
        >
          <div className="2xl:col-span-8 lg:col-span-6 col-span-12">
            <div className="flex flex-col h-full justify-end">
              ...
              >
                {title}
                <span className={`${variantStyles[variant]}`}>.</span>
              </h1>
              ...
              {subtitle && (
                <p
                  ...
                  data-aos-delay="250"
                  data-aos-duration="1000"
                  className="text-white text-xl lg:text-left text-center mb-8"
                >
                  {subtitle}
                </p>
              )}
              ...
              >
                ...
                <form>
                  <div className="py-4 border-b border-border dark:border-dark_border">
                    ...
                    <select
                      id="destination"
                      className="focus:outline-hidden w-full text-midnight_text dark:text-white text-xl font-medium dark:bg-darklight"
                    >
                  ...
                  <button
                    type="submit"
                    className={`py-4 hover:opacity-90 text-white text-base font-medium w-full rounded-lg transition-all duration-300 ${
                      variant === 'luxury'
                        ? 'bg-yellow-600'
                        : variant === 'adventure'
                          ? 'bg-green-600'

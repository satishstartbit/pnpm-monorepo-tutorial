...
const Footer = ({ variant = 'default', companyName = 'Holiday Deals', logoText = 'Holiday Deals', logoImage, contactPhone = '(630) 0536 220', contactEmail = 'info@holidaydeals.com' }) => {
    ...
    return (<footer className='dark:bg-darkmode relative z-1 md:pt-24 pt-16'>
          ...
          <div className='lg:col-span-7 md:col-span-8 col-span-12 md:mt-0 mt-8'>
            <div className='grid lg:grid-cols-2 lg:gap-0 gap-3 grid-cols-1 md:pb-16 pb-10 border-b border-border dark:border-dark_border'>
              <div>
                ...
                <Link href={`tel:${contactPhone}`} className='text-xl font-bold text-midnight_text dark:text-white'>
                  {contactPhone}
                </Link>
              </div>
              <div>
                ...
                <Link href={`mailto:${contactEmail}`} className='text-xl font-bold text-midnight_text dark:text-white hover:text-primary dark:hover:text-primary'>
                  {contactEmail}
                </Link>
              </div>
            </div>
            <div className='grid sm:grid-cols-3 grid-cols-2 py-8'>
              <div>
                ...
                <ul className=''>
                  <li className='mb-2'>
                    <Link href='/about' className='text-grey hover:text-primary text-base'>
                      About Us
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/blog' className='text-grey hover:text-primary text-base'>
                      Blog
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/testimonials' className='text-grey hover:text-primary text-base'>
                      Success Stories
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/careers' className='text-grey hover:text-primary text-base'>
                      Careers
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className=''>
                  <li className='mb-2'>
                    <Link href='/hotels' className='text-grey hover:text-primary text-base'>
                      Stay
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/flights' className='text-grey hover:text-primary text-base'>
                      Flight
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/transport' className='text-grey hover:text-primary text-base'>
                      Train
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/destination' className='text-grey hover:text-primary text-base'>
                      Destinations
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className=''>
                  <li className='mb-2'>
                    <Link href='/contact' className='text-grey hover:text-primary text-base'>
                      Contact us
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/destinations' className='text-grey hover:text-primary text-base'>
                      Top Destinations
                    </Link>
                  </li>
                  <li className='mb-2'>
                    <Link href='/featured' className='text-grey hover:text-primary text-base'>
        ...
        <div className='sm:pt-12 pt-5 grid grid-cols-12 sm:gap-7 gap-2 pb-12'>
          <div className='flex items-center gap-4 lg:col-span-5 md:col-span-4 col-span-12'>
            <Link href='#' className='text-primary hover:text-blue-800'>
              <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' version='1.0' width='30' height='30' viewBox='0 0 50 50' className='icon icons8-Facebook-Filled rounded-full fill-primary hover:fill-blue-700'>
                <path d='M40,0H10C4.486,0,0,4.486,0,10v30c0,5.514,4.486,10,10,10h30c5.514,0,10-4.486,10-10V10C50,4.486,45.514,0,40,0z M39,17h-3 c-2.145,0-3,0.504-3,2v3h6l-1,6h-5v20h-7V28h-3v-6h3v-3c0-4.677,1.581-8,7-8c2.902,0,6,1,6,1V17z'></path>
              </svg>
            </Link>
            <Link href='#' className='group'>
              <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='white' className='bi bi-twitter-x bg-primary group-hover:bg-blue-700 dark:fill-darkmode rounded-md' viewBox='-5 -5 25 25'>
                <path d='M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z'/>
              </svg>
            </Link>
            <Link href='#' className='group'>
              <svg width='30' height='30' viewBox='0 0 31 33' fill='#2F73F2' xmlns='http://www.w3.org/2000/svg' className='group-hover:fill-blue-800'>
          ...
          <div className='lg:col-span-7 md:col-span-8 sm:col-span-10 col-span-12 flex sm:flex-row flex-col lg:gap-24 md:gap-12 sm:gap-6 justify-between'>
            ...
            <div className='flex-1'>
              <form className='flex items-stretch justify-end'>
                <input type='email' placeholder='Email address*' className='border border-border dark:border-dark_border py-3 px-4 rounded-s-lg rounded-e-none! w-full focus-visible:outline-0 focus:border-primary dark:focus:border-primary dark:text-white  dark:bg-darkmode'/>

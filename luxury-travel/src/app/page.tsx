...
export const metadata: Metadata = {
  title: "Travel - Your Dream Vacation Awaits",
  description: "Discover amazing Travel and travel packages. Book your dream vacation today with exclusive offers on tours, hotels, and experiences worldwide.",
};
